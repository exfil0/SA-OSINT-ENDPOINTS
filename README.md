# [GSM/LTE/5G/6G] FalconOne IMSI/TMSI and SMS Catcher Blueprint V6 (Ubuntu-Adapted with Multi-Generation Support, O-RAN/NTN Extensions, and Enhanced Exploits)

**Research & Development Team**  
**Version Status: 6.0 TOP CONFIDENTIAL**  
...
Verification: `./src/LTESniffer -h` (usage); build log no errors.  
...
1. ue.conf: `device_name = uhd`, `release = 15`, `nof_carriers = 1`. Verification: `srsue --check`.  
...
cmake ../ && make -j$(nproc)  
```  
Verification: `sudo ./sni5gect -h` (usage).  
...
2. Build: `git clone https://gitlab.eurecom.fr/oai/openairinterface5g.git -b develop; cd cmake_targets; ./build_oai -w USRP --ninja --nrUE --gNB -C`. Verification: Binaries exist.  
...
5. Run: `sudo ./nr-softmodem -O conf`. Verification: Cell enabled.  
